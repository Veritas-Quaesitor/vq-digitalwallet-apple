  ...
  function (window, noGlobal) {
    ...
    function generateUUID() {
      ...
      if (
        ...
        console.warn(
          "[EpsApplePay] Using insecure UUID generation (Math.random). " +
    ...
    EpsApplePay.prototype = {
            ...
            .then(function (canPay) {
              ...
              if (self.config.mode === "development") {
                if (canPay) {
                  ...
                  console.warn(
                    "[EpsApplePay] Apple Pay not available on this device",
                  );
                }
              }
      ...
      _handlePaymentMethodChange: function (event) {
        if (this.config.mode === "development") {
          console.log(
            "[EpsApplePay] Payment method changed:",
            event.methodName,
          );
        }
     ...
     * @readonly
     */
    EpsApplePay.ERROR_CODES = Object.freeze
